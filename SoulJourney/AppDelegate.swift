...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //设置微信key wx557744e37f5aad59
        UMSocialWechatHandler.setWXAppId("wxd930ea5d5a258f4f", appSecret: "db426a9829e4b49a0dcac7b4162da6b6", url: nil)
        
        //设置数据库路径
         MagicalRecord.setupCoreDataStackWithStoreNamed("TrackLine.sqlite")
        
        //高德地图的Key
        AMapServices.sharedServices().apiKey = "45cae2e32c1eb72176325b512c5994c0"
        ...
        //设置Bmob的key
        Bmob.registerWithAppKey("233708c9172b286e734c6591fd06e79b")
